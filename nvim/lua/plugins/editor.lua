...
return {
  -- ---------------------------------------------------------------------------
  -- Treesitter - Syntax highlighting and AST
  -- ---------------------------------------------------------------------------
  {
    ...
    opts = function()
      ...
      return {
        ...
        custom_textobjects = {
          ...
          t = { "<([%p%w]-)%f[^<%w][^<>]->.-</%1>", "^<.->().googletag<googletag./%w+googletag>()$" },
        },
      }
    end,
  },
  ...
  -- ---------------------------------------------------------------------------
  -- mini.pairs - Auto pairs (alternative to nvim-autopairs)
  -- ---------------------------------------------------------------------------
  -- Uncomment if you prefer mini.pairs over nvim-autopairs
  -- {
  ...
  -- ---------------------------------------------------------------------------
  -- mini.indentscope - Active indent guide
  -- ---------------------------------------------------------------------------
  {
